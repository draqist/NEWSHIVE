...
const Trending = () => {
  ...
  return (
    <>
      <Heading my={['13px','20px']} color='black' fontFamily='Oswald' fontWeight='400' px={['25px','','40px','60px','100px']}> Trending News </Heading>
      <Flex color='black' justifyContent='space-between' alignItems={['flex-start','','flex-start']} px={['25px','','40px','60px','100px']} pb='40px' flexGrow='1' direction={['column','column', 'row']} mt={['14px','30px']} w='100%'>
        {
