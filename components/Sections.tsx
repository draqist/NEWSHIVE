...
export const Sections = (props: any) => {
  ...
  return (
    <>
      <Flex data-scroll-section justifyContent='space-between' direction={['column','row']} alignItems='flex-start' mb={['0px','','50px']} borderTop='2px solid black' py='25px' w='100%'>
        <Flex data-scroll data-scroll-speed='1' mb={['1rem', '0']} direction={['row', 'column']} justifyContent={['space-between', 'unset', 'unset']} w='100%'>
        ...
        <Stack direction={['column','row']} gap='2' data-scroll data-scroll-speed='3'>
