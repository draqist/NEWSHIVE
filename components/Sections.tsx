...
export const Sections = (props: any) => {
  ...
  return (
    <>
      <Flex justifyContent='space-between' direction={['column','row']} alignItems='flex-start' mb={['0px','','50px']} borderTop='2px solid black' py='25px' w='100%' color='black'>
        ...
        <Stack direction={['column','row']} gap='2' >
          <Box w={['','','200px','240px','240px']} h='240px'>
            ...
            <NextLink href='' >
              <Link href={res?.link} isExternal outline='0' _focus={{outline: 0}} textTransform='uppercase' fontWeight='300' color='twitter.600'> Read article <ExternalLinkIcon/> </Link>
            </NextLink>
          </Box>
