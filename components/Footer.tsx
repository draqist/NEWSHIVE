        ...
        >
          ...
          <Box fontWeight="300">
            ...
            <Link href="https://twitter.com/Hackth8r">
              <Text my="14px" cursor="pointer">
                {' '}
                Twitter <ExternalLinkIcon ml="6px" />{' '}
              </Text>
            </Link>
            <Link href="https://github.com/Draqode">
              <Text mb="14px" cursor="pointer">
                {' '}
                Github <ExternalLinkIcon ml="6px" />{' '}
              </Text>
            </Link>
            <Link href="https://draq.hashnode.dev">
              <Text cursor="pointer">
                {' '}
                Hashnode <ExternalLinkIcon ml="6px" />
              </Text>
            </Link>
          </Box>
        </Flex>
